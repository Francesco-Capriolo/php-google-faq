...
$links=["introduzione", "Norme sulla privacy", "Termini di serivizio", "Tecnologia", "Domande Frequenti"];
...
<title>Goolge Faq</title>
</head>

<body>

<header class="container-fluid">
    <section class="top-header row justify-content-between mt-2">
            <div class="col-4 d-flex align-items-center">
                <img src="https://media-cldnry.s-nbcnews.com/image/upload/t_fit-760w,f_auto,q_auto:best/streams/2013/March/130326/1C6639340-google-logo.jpg" alt="logo google">
                <h5>
                    Privacy e termini
                </h5>
            </div>
            <div class="col-1 d-flex align-items-center">
                <i class="fas fa-th"></i>
                <p class="account p-2 px-3 text-white m-0 ms-3 bg-success">
                    F
                </p>
            </div>
        </section>
...
<section class="row answer justify-content-center">
